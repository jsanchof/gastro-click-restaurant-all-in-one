...
def generate_sitemap():
    ...
    sitemap.add_url('/reservas', priority=0.8, changefreq='daily')
    sitemap.add_url('/contacto', priority=0.7, changefreq='monthly')
    sitemap.add_url('/nosotros', priority=0.6, changefreq='monthly')
