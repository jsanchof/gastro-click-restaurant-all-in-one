  ...
  const getAvailableTables = () => {
    ...
    if (reservaToEdit && reservaToEdit.table_id) {
      return tables.filter(
        (table) => (table.status === "LIBRE" && table.chairs >= quantity) || table.id === Number(reservaToEdit.table_id)
      )
    }
    return tables.filter((table) => table.status === "LIBRE" && table.chairs >= quantity)
  }
      ...
      <div className="modal-dialog modal-dialog-centered modal-lg">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title">{reservaToEdit ? "Editar Reservación" : "Crear Nueva Reservación"}</h5>
                      ...
                      <div>
                        <div className="mb-3">
                          <div className="d-flex gap-2">
                            ...
                            <span className="badge bg-warning">RESERVADA</span>
                        ...
                        <div className="row g-2">
                          {tables.map((table) => (
                            <div key={table.id} className="col-md-3 col-6">
                              <div
                                className={`card ${
                                  (table.status === "LIBRE" && table.chairs >= formData.quantity) ||
                              ...
                              >
                                ...
                                >
                                  ...
                                  <span className="badge bg-light text-dark">{table.chairs} sillas</span>
                                </div>
                                <div className="card-body p-2 text-center">
                                  ...
                                  (reservaToEdit && table.id === Number(reservaToEdit.table_id)) ? (
                                    ...
                                    <small>
                                      {table.status !== "LIBRE" ? "No disponible" : "Capacidad insuficiente"}
                                    </small>
                                  )}
                                </div>
                              </div>
                          ...
                          {getAvailableTables().length === 0 && (
                            <div className="col-12">
                              <div className="alert alert-warning">
                                No hay mesas disponibles para {formData.quantity} personas.
                              </div>
                            </div>
                          )}
                        </div>
