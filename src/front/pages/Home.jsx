...
export const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>El Mexicano | Restaurante de Comida Mexicana</title>
        <meta name="description" content="Auténtica comida mexicana en Pachuca. Prueba nuestros tacos, enchiladas, guacamole y más. ¡Reserva ahora!" />
        <meta name="keywords" content="restaurante mexicano, comida mexicana, enchiladas, tacos, guacamole, Pachuca" />
        <meta property="og:title" content="El Mexicano | Restaurante de Comida Mexicana" />
        <meta property="og:description" content="Disfruta de auténticos sabores mexicanos en nuestro restaurante en Pachuca. ¡Haz tu reserva hoy!" />
        <meta property="og:image" content="https://images.unsplash.com/photo-1613514785940-daed07799d9b?q=80&w=1000&auto=format&fit=crop" />
        <meta property="og:url" content="https://sample-service-name-0664.onrender.com/" />
      </Helmet>
      <div className="home-container">
        ...
        >
          <div className="container text-center text-white">
            ...
            <div className="d-flex justify-content-center gap-3 animate__animated animate__fadeInUp">
              <Link to="/reservas" className="btn btn-danger btn-lg px-4 py-2">
                Reservar Mesa
              </Link>
        ...
        <section className="py-5 bg-danger text-white text-center">
          <div className="container">
            ...
            <p className="lead mb-4">
              Reserva tu mesa ahora y disfruta de la auténtica cocina mexicana en un ambiente acogedor.
            </p>
            <Link to="/reservas" className="btn btn-light btn-lg px-5">
              Reservar Mesa
            </Link>
          </div>
        </section>
