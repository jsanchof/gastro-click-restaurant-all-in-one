    ...
    const columns = [
        ...
        },
        {
            ...
            render: (row) => (
                <span
                    style={{
                        backgroundColor: row.estado === "Completada"
                    ...
                    {row.estado === "En proceso" && (
                        <>
                            <Button
                                variant="outline"
                                size="small"
                                onClick={() => handleCambiarEstado(row.id, "Completada")}
                            ...
                            <Button
                                variant="outline"
                                size="small"
                                onClick={() => handleCambiarEstado(row.id, "Cancelada")}
    ...
    return (
        <Container maxWidth="xl">
                        ...
                        <Card>
                            <div style={{ padding: spacing.lg }}>
                                ...
                                <div style={{ display: 'flex', gap: spacing.sm }}>
                                    ...
                                    <Button
                                        variant={filtroEstado === "En proceso" ? "primary" : "outline"}
                                    ...
                                    <Button
                                        variant={filtroEstado === "Cancelada" ? "primary" : "outline"}
            ...
            <Modal
                ...
                title={`Detalles de la Orden #${ordenDetalle?.ordenId}`}
                size="large"
            >
                {ordenDetalle && (
                    <div>
                        <div style={{
                            ...
                            <div>
                                <p style={{ margin: 0 }}>
                                    ...
                                    <span style={{
                                        backgroundColor: ordenDetalle.estado === "Completada"
                                            ? colors.status.success
